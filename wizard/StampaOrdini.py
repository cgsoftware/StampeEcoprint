...
class stampa_ordini(osv.osv_memory):
    ...
    def _build_contexts(self, cr, uid, ids, data, context=None):
        if context is None:
            context = {}
        result = {}
        result = {'danr':data['form']['danrv'],'anr':data['form']['anrv'],
                    'dadata':data['form']['dadata'],'adata':data['form']['adata'], 
                    'prezzi':data['form']['prezzi'], 'tipo':data['form']['tipo']
                    }
        ...
        if var == True or var == 1:
            result = {'danr':data['form']['danrv'],'anr':data['form']['anrv'],'dadata':data['form']['dadata'],
                  'adata':data['form']['adata'], 'tipo':data['form']['tipo'], 'prezzi':1}
        else:
            result = {'danr':data['form']['danrv'],'anr':data['form']['anrv'],'dadata':data['form']['dadata'],
                  'adata':data['form']['adata'], 'tipo':data['form']['tipo'], 'prezzi':0,}
        return result
    ...
    def check_report(self, cr, uid, ids, context=None):
        ...
        data['form'] = self.read(cr, uid, ids, ['dadata',  'adata',  'danrv', 'anrv', 'prezzi', 'tipo'])[0]
